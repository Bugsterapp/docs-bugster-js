...
2. **Bugster Dashboard**
   ...
   Log in to the [Bugster Dashboard](https://app.bugster.io) to view detailed execution status, including:
...
If you encounter any issues or have questions about cloud execution, don't hesitate to [contact our support team](https://bugster.io/support) or visit our [community forums](https://community.bugster.io).
