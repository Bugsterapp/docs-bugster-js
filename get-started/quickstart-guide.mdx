...
<Note>
You can find your project ID in the Bugster dashboard under Project Settings.
</Note>
...
2. Perform some typical user actions (e.g., click buttons, fill forms)
3. These interactions will be sent to the Bugster servers

## Step 5: View Captured Interactions

To view the captured interactions:

1. Log in to your [Bugster Dashboard](https://dashboard.bugster.io)
2. Navigate to your project
3. Click on "Captured Interactions"
...
1. In the Bugster Dashboard, go to "Captured Interactions"
2. Select a sequence of interactions you want to turn into a test
...
<Tip>
You can also run tests locally or integrate them into your CI/CD pipeline. Check our [Advanced Usage Guide](/advanced-usage) for more details.
</Tip>
...
- [Customize Interaction Capturing](/guides/customizing-capture): Learn how to fine-tune what interactions are captured
- [Test Management](/guides/test-management): Organize and manage your growing test suite
- [CI/CD Integration](/guides/ci-cd-integration): Integrate Bugster tests into your continuous integration workflow
- [Advanced Configuration](/configuration): Explore advanced configuration options for Bugster SDK

## Troubleshooting

If you encounter any issues:

- Ensure your `projectId` is correct
...
If you need further assistance, don't hesitate to [contact our support team](https://bugster.io/support).
