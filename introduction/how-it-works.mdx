...
import BugsterSDK from 'bugster-js';
...
<Note>
  Ensure you replace 'YOUR_PROJECT_ID' with the actual project ID provided in your Bugster dashboard.
</Note>
...
<img src="/images/story-review-dashboard.png" alt="Bugster Story Review Dashboard" />
...
test('User can create a new project', async ({ page }) => {
  ...
  await page.fill('#project-name', 'New Test Project');
  await page.fill('#project-description', 'This is a test project');
  await page.click('#submit-project');
  await page.waitForSelector('.project-list-item:has-text("New Test Project")');
});
```
...
<img src="/images/test-management-interface.png" alt="Bugster Test Management Interface" />
...
For more detailed information on setting up and using Bugster SDK, please refer to our [API Reference](/api-reference) and [Configuration Guide](/configuration).
